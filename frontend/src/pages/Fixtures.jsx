...
import { FixtureCard, TeamCrest, RoundSeparator, DATE_CAT_STYLE } from '../components/FixtureCard'
...
const FILTER_KEY        = 'getafix:fixtures:filter'
const SHOW_ALL_KEY      = 'getafix:fixtures:show_all'
const REVEALED_DAYS_KEY = 'getafix:fixtures:revealed_days'
  ...
  return (
    ...
    {todayVisible === false && (
      <button
        ...
        className="fixed bottom-[72px] lg:bottom-[10px] -translate-x-1/2 z-40 flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-green-600 hover:bg-green-500 text-white text-xs font-semibold shadow-lg transition-colors"
        style={{ left: window.innerWidth >= 1024 ? `calc(50% + ${112 + sidebarWidth / 2}px)` : '50%' }}
      >
